  ...
  },
  {
    ...
    featuresByLevel: {
      '1': [
        ...
        {
          id: 'druida-vinculo-natural',
          name: 'Vínculo Natural',
          aliases: ['Vinculo Natural', 'Nível 1: Vínculo Natural', 'Nivel 1: Vinculo Natural'],
          level: 1,
          kind: 'classFeature',
          description: 'A personagem estabelece um elo ritualizado com a natureza, usando esse vínculo como base para interações, invocações leves e leitura do ambiente.',
          sourceUrl: druidUrl,
        },
        {
          id: 'druida-ordem-primal',
          name: 'Ordem Primal',
          aliases: ['Ordem Primal', 'Nível 1: Ordem Primal', 'Nivel 1: Ordem Primal'],
          level: 1,
          kind: 'classFeature',
          description: 'Ordem Primal define a ênfase inicial do Druida, moldando o modo como ele transforma conhecimento natural em presença ritual, defesa ou orientação espiritual.',
          sourceUrl: druidUrl,
        },
        {
          id: 'druida-ordem-primal-xama',
          name: 'Ordem Primal: Xamã',
          aliases: ['Ordem Primal: Xama', 'Nível 1: Ordem Primal: Xamã', 'Nivel 1: Ordem Primal: Xama'],
          level: 1,
          kind: 'classFeature',
          description: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
          shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
          sourceUrl: druidUrl,
        },
        {
          id: 'druida-ordem-primal-guardiao',
          name: 'Ordem Primal: Guardião',
          aliases: ['Ordem Primal: Guardiao', 'Nível 1: Ordem Primal: Guardião', 'Nivel 1: Ordem Primal: Guardiao'],
          level: 1,
          kind: 'classFeature',
          description: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
          shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
      ...
      '2': [
        {
          ...
          name: 'Forma Selvagem',
          aliases: ['Forma Silvestre', 'Wild Shape'],
          level: 2,
          kind: 'classFeature',
          description: 'A Druida assume formas naturais para adaptação, sobrevivência e expressão do elo primal com o mundo vivo.',
          sourceUrl: druidUrl,
        },
      ],
      '5': [
        {
          id: 'druida-surto-selvagem',
          name: 'Surto Selvagem',
          aliases: ['Surto Selvagem', 'Nível 5: Surto Selvagem', 'Nivel 5: Surto Selvagem'],
          level: 5,
          kind: 'classFeature',
          description: 'Surto Selvagem traduz um pico de energia primal em efeitos ampliados de presença natural, mobilidade ritual ou poder temático da personagem.',
          sourceUrl: druidUrl,
        },
        {
          id: 'druida-surto-selvagem-elo-primal',
          name: 'Surto Selvagem: Elo Primal',
          aliases: ['Nível 5: Surto Selvagem: Elo Primal', 'Nivel 5: Surto Selvagem: Elo Primal'],
          level: 5,
          kind: 'classFeature',
          description: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
          shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
        ...
        {
          id: 'druida-surto-selvagem-veu-do-crepusculo',
          name: 'Surto Selvagem, Véu do Crepúsculo',
          aliases: ['Surto Selvagem, Veu do Crepusculo', 'Nível 5: Surto Selvagem, Véu do Crepúsculo', 'Nivel 5: Surto Selvagem, Veu do Crepusculo'],
          level: 5,
          kind: 'classFeature',
          description: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
          shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
        ...
        {
          id: 'druida-intuicao-selvagem',
          name: 'Intuição Selvagem',
          aliases: ['Intuicao Selvagem'],
          level: 5,
          kind: 'classFeature',
          description: 'A Intuição Selvagem representa leitura instintiva de perigo, trilha, criatura e ritmo do ambiente, reforçando a percepção do Druida sobre o mundo vivo.',
          sourceUrl: druidUrl,
        },
        {
          id: 'druida-refugio-onirico',
          name: 'Refúgio Onírico',
          aliases: ['Refugio Onirico'],
          level: 5,
          kind: 'classFeature',
          description: '',
          shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
...
export const bonfireRaceSeeds: BonfireRaceRule[] = [
  {
    ...
    features: [
      {
        id: 'elfo-da-lua-ancestralidade-feerica',
        name: 'Ancestralidade Feérica',
        aliases: ['Ancestralidade Feerica', 'Fey Ancestry'],
        kind: 'raceFeature',
        description: 'A linhagem feérica protege a personagem contra encantamentos comuns e reforça sua afinidade ancestral com magia sutil.',
        sourceUrl: humanoidsUrl,
      },
      {
        id: 'elfo-da-lua-transe-elfico',
        name: 'Transe Élfico',
        aliases: ['Transe Elfico', 'Trance'],
        kind: 'raceFeature',
        descriptionText: 'Elfos não precisam dormir. Em vez disso, meditam profundamente, permanecendo semiconscientes, durante 4 horas por dia. Após descansar dessa forma, você ganha os mesmos benefícios que um humano ganharia após 8 horas de sono.',
        description: 'Elfos não precisam dormir. Em vez disso, meditam profundamente, permanecendo semiconscientes, durante 4 horas por dia. Após descansar dessa forma, você ganha os mesmos benefícios que um humano ganharia após 8 horas de sono.',
        descriptionStatus: 'complete',
        descriptionSource: 'section-body',
        sourceUrl: humanoidsUrl,
      },
      {
        id: 'elfo-da-lua-sentidos-entreplanos',
        name: 'Sentidos Entreplanos',
        aliases: ['Sentidos Entreplanos'],
        kind: 'raceFeature',
        description: '',
        shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
        sourceUrl: humanoidsUrl,
      ...
      {
        id: 'elfo-da-lua-lestos-como-o-vento',
        name: 'Lestos como o Vento',
        aliases: ['Lestos como o vento'],
        kind: 'raceFeature',
        description: '',
        shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
        sourceUrl: humanoidsUrl,
      ...
      {
        id: 'elfo-da-lua-sonho-da-lua',
        name: 'Sonho da Lua',
        aliases: ['Sonho da Lua'],
        kind: 'raceFeature',
        description: '',
        shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
        sourceUrl: humanoidsUrl,
      ...
      {
        id: 'elfo-da-lua-bruma-serenante',
        name: 'Bruma Serenante',
        aliases: ['Bruma Serenante'],
        kind: 'raceFeature',
        description: '',
        shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
        sourceUrl: humanoidsUrl,
  ...
  },
  {
    ...
    features: [
      ...
      {
        id: 'folken-mente-genial',
        name: 'Mente Genial',
        aliases: ['Mente Genial'],
        kind: 'raceFeature',
        descriptionText: 'Sua mente opera em caminhos não lineares que a magia hostil tem dificuldade de prender. Você tem Vantagem em Testes de Resistência de Inteligência, Sabedoria e Carisma contra magias e efeitos mágicos.',
        description: 'Sua mente opera em caminhos não lineares que a magia hostil tem dificuldade de prender. Você tem Vantagem em Testes de Resistência de Inteligência, Sabedoria e Carisma contra magias e efeitos mágicos.',
        descriptionStatus: 'complete',
        descriptionSource: 'section-body',
        sourceUrl: humanoidsUrl,
      },
...
export const bonfireBackgroundSeeds: BonfireBackgroundRule[] = [
  ...
  {
    id: 'juramento-tres-luas',
    name: 'Juramento Três Luas',
    aliases: ['Juramento Tres Luas', 'Juramento Três luas', 'Juramento Três Luas', 'Iniciado no Juramento das Três Luas', 'Iniciado no Juramento das Tres Luas'],
    description: '',
    shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
    features: [
      {
        id: 'background-juramento-tres-luas',
        name: 'Juramento Três Luas',
        aliases: ['Juramento Tres Luas', 'Iniciado no Juramento das Três Luas', 'Iniciado no Juramento das Tres Luas'],
        kind: 'backgroundFeature',
        description: '',
        shortDescription: 'Descrição completa ainda não cadastrada no seed local. Regra preservada da ficha para revisão.',
        sourceUrl: playersUrl,
...
export const bonfireFeatSeeds: BonfireFeatRule[] = [
  ...
  { id: 'lider-inspirador', name: 'Líder Inspirador', aliases: ['Lider Inspirador', 'Inspiring Leader'], description: 'Talento de presença e discurso capaz de elevar moral, organização e resistência do grupo antes do conflito.', shortDescription: 'Talento de liderança e preparação do grupo.', category: 'general', prerequisites: [], effects: ['Talento oficial com alias PT/EN.'], sourceUrl: playersUrl },
  { id: 'teletransporte-feerico', name: 'Teletransporte Feérico', aliases: ['Teletransporte Feerico', 'Fey Teleportation'], description: 'Talento ligado à herança feérica e à mobilidade arcana breve.', shortDescription: 'Talento feérico de mobilidade curta.', category: 'racial', prerequisites: [], effects: ['Talento oficial com alias PT/EN.'], sourceUrl: playersUrl },
  { id: 'iniciado-em-magia', name: 'Iniciado em Magia', aliases: ['Magic Initiate'], description: 'Talento introdutório de treinamento mágico fora da classe principal.', shortDescription: 'Talento de iniciação mágica.', category: 'general', prerequisites: [], effects: ['Talento oficial com alias PT/EN.'], sourceUrl: playersUrl },
  { id: 'sortudo', name: 'Sortudo', aliases: ['Lucky'], description: 'Talento que permite dobrar o acaso em momentos importantes.', shortDescription: 'Talento de controle limitado do acaso.', category: 'general', prerequisites: [], effects: ['Talento oficial com alias PT/EN.'], sourceUrl: playersUrl },
  { id: 'alerta', name: 'Alerta', aliases: ['Alert'], description: 'Talento de prontidão, leitura de ameaça e reação antecipada.', shortDescription: 'Talento de vigilância e resposta rápida.', category: 'general', prerequisites: [], effects: ['Talento oficial com alias PT/EN.'], sourceUrl: playersUrl },
