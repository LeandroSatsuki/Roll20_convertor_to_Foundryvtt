...
export const bonfireRaceSeeds: BonfireRaceRule[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        kind: 'raceFeature',
        description: 'Elfos da Lua descansam em transe meditativo, mantendo percepção alterada do tempo e da memória.',
        sourceUrl: humanoidsUrl,
      },
      {
  ...
  },
  {
    ...
    features: [
      { id: 'folken-sorte-incontrolavel', name: 'Sorte Incontrolável', aliases: ['Sorte Incontrolavel'], kind: 'raceFeature', description: 'A sorte dos Limalumes parece dobrar o acaso a seu favor em momentos críticos, mesmo quando nem eles entendem o motivo.', sourceUrl: humanoidsUrl },
      {
        ...
        kind: 'raceFeature',
        description: '',
        shortDescription: 'Os Folken Limalumes demonstram raciocínio vivo, imaginação rápida e capacidade de conectar ideias improváveis.',
        descriptionStatus: 'summary-only',
        descriptionSource: 'card-summary',
        needsReviewReasons: ['summary-card-used-no-full-description', 'missing-full-rule-page'],
        sourceUrl: humanoidsUrl,
      },
