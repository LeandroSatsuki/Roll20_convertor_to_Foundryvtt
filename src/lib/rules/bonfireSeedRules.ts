...
export const bonfireSpellOverrideSeeds: BonfireSpellOverrideRule[] = [
  ...
  { id: 'mind-sliver', spellName: 'Mind Sliver', status: 'allowed', baseDescription: 'Ataque psíquico breve que fere a mente do alvo e fragiliza sua próxima resistência.', foundryNotes: 'Magia liberada sem ajuste Bonfire.', sourceUrl: spellsUrl },
  ...
  { id: 'protection-from-evil-and-good', spellName: 'Protection from Evil and Good', status: 'allowed', baseDescription: 'Proteção espiritual contra certos tipos de criatura, prejudicando sua influência e aproximação.', foundryNotes: 'Magia liberada sem ajuste Bonfire.', sourceUrl: spellsUrl },
  ...
  { id: 'augury', spellName: 'Augury', status: 'allowed', baseDescription: 'Divinação breve para avaliar se um curso de ação tende a trazer bons ou maus presságios no futuro imediato.', foundryNotes: 'Magia liberada sem ajuste Bonfire.', sourceUrl: spellsUrl },
  { id: 'algury', spellName: 'Algury', status: 'allowed', baseDescription: 'Alias local para Augury; mantém a mesma leitura de presságios para decisões imediatas.', foundryNotes: 'Magia liberada sem ajuste Bonfire.', sourceUrl: spellsUrl },
