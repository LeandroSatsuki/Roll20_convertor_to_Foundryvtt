  ...
  return [
    {
      ...
      actorJson: {
        ...
        items: [
          ...
          feat('Spellcasting', { effects: true }),
          feat('Wild Companion', { effects: true }),
          feat('Primal Order', { effects: true }),
          feat('Wild Resurgence', { effects: true }),
          feat('Inspiring Leader', { effects: true }),
          feat('Fey Teleportation', { effects: true }),
          feat('Magic Initiate', { effects: true }),
          feat('Lucky', { effects: true }),
          feat('Alert', { effects: true }),
          feat('Fey Ancestry', { effects: true }),
          feat('Trance', { effects: true }),
          feat('Keen Senses', { effects: true }),
