...
describe('bonfire log combat parsing', () => {
  it('extracts ac, hp, speed and a valid passive perception from samples/clerigo-level5.xlsx', async () => {
    ...
    expect(result.character.attributes.passivePerception.value).toBe(14)
