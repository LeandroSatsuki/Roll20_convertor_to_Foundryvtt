...
export function createWorkbookData(sheets: Array<{ name: string; rows: string[][]; hidden?: boolean; veryHidden?: boolean; merges?: Array<{ s: { r: number; c: number }; e: { r: number; c: number } }> }>): Uint8Array {
